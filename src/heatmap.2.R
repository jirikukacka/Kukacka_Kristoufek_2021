...
### jirikukacka: the following part of the code was downloaded from https://rdrr.io/cran/gplots/src/R/heatmap.2.R [accessed 2019-06-24]
...
)
{
  ...
  if(!is.null(xlab)) mtext(xlab, side = 1,
                           line = margins[1] - 1.25 + cex.lab / 10,
                           cex = cex.lab)
  if(!is.null(ylab)) mtext(ylab, side = 4,
                           line = margins[2] - 1.25 + cex.lab / 10,
                           cex = cex.lab)
